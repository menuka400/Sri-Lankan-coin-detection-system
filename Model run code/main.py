...
def Sri_Lankan_coin_detection_system():
    yolo_model = YOLO('system#\\train\\weights\\best.pt')
    ...
    while True:
        ...
        cv2.imshow('Sri_Lankan_coin_detection_system', frame)
...
Sri_Lankan_coin_detection_system()